...
de los *esports* de referencia y que más público atraen.
...
ejemplo dentro de los *tanques* hay campeones con distintos niveles de ataque,
...
* Los campeones tienen distintos roles en los que se desempeñan:
    ...
    * Mago o Hechicero: Especializado en habilidades y daño mágico. Popularmente
    conocido como *AP Carry* del inglés *ability power carry* o carreador de
    poder de habilidad.
